<template>
  <div class="menu-page">
    ...
    <section class="py-24 bg-primary-900 text-white relative overflow-hidden">
      ...
      <HeaderSection title="Our Menu" desc="Explore the rich and authentic flavors of Malawi." />
    ...
    <!-- Menu Section -->
    <section class="lg:w-7xl m-auto w-auto py-24 bg-gray-50 min-h-screen">
      <div class="container mx-auto px-4">
        <!-- Category Filter -->
        <div class="flex flex-wrap justify-center gap-4 mb-16">
          <button v-for="cat in categories" :key="cat.id" @click="activeCategory = cat.id"
            class="px-8 py-3 rounded-full font-bold text-lg transition-all border-2" :class="activeCategory === cat.id
